...
public interface StarcoinNodeHeartbeatRepository extends JpaRepository<StarcoinNodeHeartbeat, NodeHeartbeatId> {
    ...
    @Query(nativeQuery = true, value = "SELECT DISTINCT\n" +
            ...
            "    FROM\n" +
            "        starcoin_node_heartbeat b\n" +
            "    LEFT JOIN starcoin_node_heartbeat c ON b.node_id != c.node_id\n" +
            ...
            "    FROM\n" +
            "        starcoin_node_heartbeat b\n" +
            "    LEFT JOIN starcoin_node_heartbeat a ON b.node_id != a.node_id\n" +
            ...
            "                MIN(b.started_at)\n" +
            "            FROM\n" +
            "                starcoin_node_heartbeat b)) AS g\n" +
