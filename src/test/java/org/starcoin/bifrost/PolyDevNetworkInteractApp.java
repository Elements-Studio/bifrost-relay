    ...
    public static void main(String[] args) {
        ...
        if (initAccountAndDeploy) {
            commandLineInteractor
                    ...
                    .expect("\"ok\":", 10)
                    .sendLine("account default 0x2d81a0427d64ff61b11ede9085efa5ad")
                    .expect("\"ok\":", 10)
                    .sendLine("account unlock 0x2d81a0427d64ff61b11ede9085efa5ad")
                    .expect("\"ok\":", 10)
                    .sendLine("dev get-coin 0x2d81a0427d64ff61b11ede9085efa5ad")
                    .expect("\"ok\":", 10)
//                    //.sendLine("account unlock 0xff2794187d72cc3a9240198ca98ac7b6")
//                    //.expect("\"ok\":", 10)
//                    .sendLine("dev get-coin 0x2d81a0427d64ff61b11ede9085efa5ad")
//                    .expect("\"ok\":", 10)
//                    .sendLine("dev deploy storage/0x2d81a0427d64ff61b11ede9085efa5ad/modules/Address.mv -b")
//                    .expect("\"ok\":", 10)
//                    .sendLine("dev deploy storage/0x2d81a0427d64ff61b11ede9085efa5ad/modules/CrosschainType.mv -b")
//                    .expect("\"ok\":", 10)
//                    .sendLine("dev deploy storage/0x2d81a0427d64ff61b11ede9085efa5ad/modules/CrosschainUtils.mv -b")
//                    .expect("\"ok\":", 10)
//                    .sendLine("dev deploy storage/0x2d81a0427d64ff61b11ede9085efa5ad/modules/CrosschainGlobal.mv -b")
//                    .expect("\"ok\":", 10)
                    // ------------------------------------
                    // 使用 package 的方式部署
