...
/**
 * Transaction table has unique constraints. Dropped transaction go here so another transaction can be resent.
 */
@Entity
@DynamicInsert
@DynamicUpdate
@Table(name = "dropped_ethereum_transaction")
public class DroppedEthereumTransaction implements EthereumTransaction {
